...
padding: 20px;'><h2>Welcome to {{systemName}}</h2><p>Hello {{target_firstName}},</p><p>Your account is ready. You can now access your workspace using your system credentials.</p></div>`;
